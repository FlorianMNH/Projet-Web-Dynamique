...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['add_agent'])) {
        ...
        $query = "INSERT INTO agentimmobilier (prenom, nom, email, photo, specialite, disponibilite_lundi_matin, disponibilite_lundi_apres_midi, disponibilite_mardi_matin, disponibilite_mardi_apres_midi, disponibilite_mercredi_matin, disponibilite_mercredi_apres_midi, disponibilite_jeudi_matin, disponibilite_jeudi_apres_midi, disponibilite_vendredi_matin, disponibilite_vendredi_apres_midi, disponibilite_samedi_matin, disponibilite_samedi_apres_midi, disponibilite_dimanche_matin, disponibilite_dimanche_apres_midi) VALUES ('$prenom', '$nom', '$email', '$photo', '$specialite',  '$disponibilite_lundi_matin', '$disponibilite_lundi_apres_midi', '$disponibilite_mardi_matin', '$disponibilite_mardi_apres_midi', '$disponibilite_mercredi_matin', '$disponibilite_mercredi_apres_midi', '$disponibilite_jeudi_matin', '$disponibilite_jeudi_apres_midi', '$disponibilite_vendredi_matin', '$disponibilite_vendredi_apres_midi', '$disponibilite_samedi_matin', '$disponibilite_samedi_apres_midi', '$disponibilite_dimanche_matin', '$disponibilite_dimanche_apres_midi')";
        if ($conn->query($query) === TRUE) {
            echo "<p>Agent immobilier ajouté avec succès.</p>";

            // Ajouter l'agent à la table utilisateur
            $query = "INSERT INTO utilisateur (prenom, nom, email, adresse, mot_de_passe, type_utilisateur) VALUES ('$prenom', '$nom', '$email', '$adresse', '$mot_de_passe', 'Agent')";
            if ($conn->query($query) === TRUE) {
                echo "<p>Agent ajouté à la table utilisateur avec succès.</p>";
            } else {
                echo "<p>Erreur lors de l'ajout de l'agent à la table utilisateur : " . $conn->error . "</p>";
            }
        } else {
...
<div class="container">
    ...
    <form method="POST" action="gérer_le_site.php">
